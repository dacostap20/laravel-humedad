...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(URL::asset('css/mapa.css')); ?>">
    <!-- End layout styles -->
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('ver-humedad')); ?>">
              <i class="mdi mdi-compass-outline menu-icon"></i>
              <span class="menu-title">Dashboard</span>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="<?php echo e(url('ver-historico')); ?>">
              <i class="mdi mdi-compass-outline menu-icon"></i>
...
<?php /**PATH E:\Diego\codigos\prueba-laravel-php-senior\resources\views/layouts/master.blade.php ENDPATH**/ ?>